...
public abstract class Product {
    ...
    public Product(String id, String name, String productLink) {
        this.id = id;
        this.name = name;
        this.productLink = productLink;
    }
